...
// //                     setOpacity("0.5")
// //                   }
// //                   console.log(disp,open)
// //               },[open])
// //               return menu ? (
// //                 <div key={link.title}>
// //                   <button onClick={()=>setOpen(!open)} className='navburcon capitalize'>{link.title}<Image style={{transform:`rotate(${angle})`,transition:"0.5s",opacity:`${opacity}`}} src={down} alt='None' /></button>
// //                   <div className={disp+' flex-col ml-3 duration-500 text-lg font-medium text-red-700'}>
// //                   {menu.map((m)=>(
// //                     <Link onClick={()=>setLeft("110%")} key={m.title} href={m.href}>{m.title}</Link>
// //               ))}</div>
// //                 </div>
// //               ) : (
...
// //                       {link.title}
// //                       <Image style={{transform:`rotate(${angle})`,transition:"0.5s"}} src={down} alt='None' />
// //                     </Button>
// //                   </DropdownTrigger>
// //                   <DropdownMenu
