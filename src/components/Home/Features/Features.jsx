        ...
        <div className='flex flex-col '>
          ...
          >
            {featuresCards.map((title) => (
              <SplideSlide
                key={title}
                className='border-[1.5px] border-solid flex flex-col border-[#EC0033] bg-[#0c090980] font-semibold text-[20px] md:text-[clamp(28px,2.6vw,36px)] xl:text-[clamp(36px,2.8vw,48px)] rounded-lg text-center text-white py-4 px-3 xl:px-6'
              >
                {title}
              </SplideSlide>
            ))}
